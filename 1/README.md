Задание: Прочитать 2 переменные из текстового файла. Поменять их значения местами без использования 3й переменной. Вывести итоговые значения в текстовый файл.
